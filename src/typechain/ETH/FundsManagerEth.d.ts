...
export class FundsManagerEth extends Contract {
  ...
  functions: {
    ...
    'setToken(address)'(_token: string, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    migrateToNewFundsManager(_newContract: string, overrides?: CallOverrides): Promise<void>;
    ...
    setPlasmaManagerAddress(_plasmaManager: string, overrides?: CallOverrides): Promise<void>;
    ...
    'setToken(address)'(_token: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    migrateToNewFundsManager(_newContract: string, overrides?: Overrides): Promise<BigNumber>;
    ...
    setPlasmaManagerAddress(_plasmaManager: string, overrides?: Overrides): Promise<BigNumber>;
    ...
    'setToken(address)'(_token: string, overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    setToken(_token: string, overrides?: Overrides): Promise<PopulatedTransaction>;

    'setToken(address)'(_token: string, overrides?: Overrides): Promise<PopulatedTransaction>;
