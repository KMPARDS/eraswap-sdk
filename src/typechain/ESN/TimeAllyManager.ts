...
export abstract class TimeAllyManager extends Contract {
  ...
  abstract interface: TimeAllyManagerInterface;
   ...
   * Admin mode status
   */
  abstract adminMode(overrides?: CallOverrides): Promise<boolean>;
   ...
   * Deactivates admin mode forever.
   */
  abstract deactivateAdminMode(overrides?: Overrides): Promise<ContractTransaction>;
   ...
   * @param _startMonth : Month from which decreasing should be done
   */
  abstract decreaseActiveStaking(
    _amount: BigNumberish,
    _startMonth: BigNumberish,
    _endMonth: BigNumberish,
    overrides?: Overrides
   ...
   * @param _startMonth : Month from which decreasing should be done
   */
  abstract 'decreaseActiveStaking(uint256,uint32,uint32)'(
    _amount: BigNumberish,
    _startMonth: BigNumberish,
    _endMonth: BigNumberish,
    overrides?: Overrides
   ...
   * Default months for stakings.
   */
  abstract defaultMonths(overrides?: CallOverrides): Promise<number>;
  ...
  abstract deployer(overrides?: CallOverrides): Promise<string>;
   ...
   * @param _childStaking : Address of new staking contract created my master staking.
   */
  abstract 'emitStakingMerge(address)'(
    _childStaking: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * @param _oldOwner : Address of sender.
   */
  abstract 'emitStakingTransfer(address,address)'(
    _oldOwner: string,
    _newOwner: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
  ...
  abstract getTotalActiveStaking(
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;

  abstract 'getTotalActiveStaking(uint32)'(
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * @param _startMonth : Month from which increasing should be done
   */
  abstract increaseActiveStaking(
    _amount: BigNumberish,
    _startMonth: BigNumberish,
    _endMonth: BigNumberish,
    overrides?: Overrides
   ...
   * @param _startMonth : Month from which increasing should be done
   */
  abstract 'increaseActiveStaking(uint256,uint32,uint32)'(
    _amount: BigNumberish,
    _startMonth: BigNumberish,
    _endMonth: BigNumberish,
    overrides?: Overrides
   ...
   * @param _stakingContract : An address to check.
   */
  abstract isStakingContractValid(
    _stakingContract: string,
    overrides?: CallOverrides
  ): Promise<boolean>;
   ...
   * @param _stakingContract : An address to check.
   */
  abstract 'isStakingContractValid(address)'(
    _stakingContract: string,
    overrides?: CallOverrides
  ): Promise<boolean>;
   ...
   * @param _rewardType : 0 => Liquid, 1 => Prepaid, 2 => Staked.
   */
  abstract 'processNrtReward(uint256,uint8)'(
    _reward: BigNumberish,
    _rewardType: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * @param _owner : Address of owner (for emiting the event).
   */
  abstract removeStaking(_owner: string, overrides?: Overrides): Promise<ContractTransaction>;

  /**
   * Removes the staking from valid staking.
   * @param _owner : Address of owner (for emiting the event).
   */
  abstract 'removeStaking(address)'(
    _owner: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * @param _receiver : Address of receipent of the staking contract.
   */
  abstract 'sendStake(address,uint256,bool[])'(
    _receiver: string,
    _initialIssTime: BigNumberish,
    _claimedMonths: boolean[],
    overrides?: PayableOverrides
  ...
  abstract setStakingTarget(
    _stakingTarget: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'setStakingTarget(address)'(
    _stakingTarget: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * @param _owner : Owner of the master staking, is set as owner of the new staking that is created.
   */
  abstract 'splitStaking(address,uint256,uint32)'(
    _owner: string,
    _initialIssTime: BigNumberish,
    _masterEndMonth: BigNumberish,
    overrides?: PayableOverrides
   ...
   * Deploys a new staking contract with value sent.
   */
  abstract stake(overrides?: PayableOverrides): Promise<ContractTransaction>;
  ...
  abstract stakingTarget(overrides?: CallOverrides): Promise<string>;
   ...
   * @param _amount : Amount of claimed NRT rewards by stakers.
   */
  abstract 'withdrawClaimedNrt(uint256)'(
    _amount: BigNumberish,
    overrides?: PayableOverrides
  ): Promise<ContractTransaction>;
