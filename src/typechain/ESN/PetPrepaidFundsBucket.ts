...
export abstract class PetPrepaidFundsBucket extends Contract {
  ...
  abstract interface: PetPrepaidFundsBucketInterface;
   ...
   * address of PET Smart Contract
   */
  abstract petContract(overrides?: CallOverrides): Promise<string>;
   ...
   * address of Era Swap ERC20 Smart Contract
   */
  abstract token(overrides?: CallOverrides): Promise<string>;
   ...
   * this function makes it possible for deployer to withdraw unallocated ES
   */
  abstract 'withdrawFunds(bool,uint256)'(
    _withdrawEverything: boolean,
    _withdrawlAmount: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
