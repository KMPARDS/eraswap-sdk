...
interface TimeAllyPromotionalBucketInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'stakingRewards', values: [string]): string;
...
export abstract class TimeAllyPromotionalBucket extends Contract {
  ...
  abstract interface: TimeAllyPromotionalBucketInterface;
  ...
  abstract stakingRewards(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;

  abstract 'stakingRewards(address)'(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  abstract callStatic: {
    ...
    'stakingRewards(address)'(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  abstract populateTransaction: {
    ...
    stakingRewards(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
