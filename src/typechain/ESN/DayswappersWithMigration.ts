...
export abstract class DayswappersWithMigration extends Contract {
  ...
  abstract interface: DayswappersWithMigrationInterface;
  ...
  abstract functions: {
    ...
    getSeatMonthlyDataByAddress(
      ...
      volume: BigNumber;
      definiteEarnings: [BigNumber, BigNumber, BigNumber];
      nrtEarnings: [BigNumber, BigNumber, BigNumber];
      isActive: boolean;
      0: number;
      1: BigNumber;
    ...
    getTotalMonthlyIndefiniteRewards(
      _month: BigNumberish,
      overrides?: CallOverrides
    ): Promise<{
      0: BigNumber;
  ...
  abstract getBeltIdFromTreeReferrals(
    treeReferrals: BigNumberish,
    overrides?: CallOverrides
  ): Promise<number>;

  abstract 'getBeltIdFromTreeReferrals(uint32)'(
    treeReferrals: BigNumberish,
    overrides?: CallOverrides
  ): Promise<number>;
  ...
  abstract 'getSeatByAddress(address)'(
    _networker: string,
    overrides?: CallOverrides
  ): Promise<{
    seatIndex: number;
  ...
  abstract getSeatByAddressStrict(
    _networker: string,
    overrides?: CallOverrides
  ): Promise<{
    seatIndex: number;
  ...
  abstract 'getSeatByAddressStrict(address)'(
    _networker: string,
    overrides?: CallOverrides
  ): Promise<{
    seatIndex: number;
  ...
  abstract 'getSeatByIndex(uint32)'(
    _seatIndex: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
    seatIndex: number;
  ...
  abstract getSeatMonthlyDataByAddress(
    _networker: string,
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
  ...
  abstract 'getSeatMonthlyDataByAddress(address,uint32)'(
    _networker: string,
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
  ...
  abstract getSeatMonthlyDataByAddressStrict(
    _networker: string,
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
  ...
  abstract 'getSeatMonthlyDataByAddressStrict(address,uint32)'(
    _networker: string,
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
  ...
  abstract getSeatMonthlyDataByIndex(
    _seatIndex: BigNumberish,
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
  ...
  abstract 'getSeatMonthlyDataByIndex(uint32,uint32)'(
    _seatIndex: BigNumberish,
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
  ...
  abstract getTotalMonthlyIndefiniteRewards(
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;

  abstract 'getTotalMonthlyIndefiniteRewards(uint32)'(
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
  ...
  abstract isActiveSeat(_seatIndex: BigNumberish, overrides?: CallOverrides): Promise<boolean>;

  abstract 'isActiveSeat(uint32)'(
    _seatIndex: BigNumberish,
    overrides?: CallOverrides
  ): Promise<boolean>;
  ...
  abstract payToIntroducer(
    _networker: string,
    _rewardRatio: [BigNumberish, BigNumberish, BigNumberish],
    overrides?: PayableOverrides
  ): Promise<ContractTransaction>;

  abstract 'payToIntroducer(address,uint256[3])'(
    _networker: string,
    _rewardRatio: [BigNumberish, BigNumberish, BigNumberish],
    overrides?: PayableOverrides
  ): Promise<ContractTransaction>;

  abstract payToNetworker(
    _networker: string,
    _rewardRatio: [BigNumberish, BigNumberish, BigNumberish],
    overrides?: PayableOverrides
  ): Promise<ContractTransaction>;

  abstract 'payToNetworker(address,uint256[3])'(
    _networker: string,
    _rewardRatio: [BigNumberish, BigNumberish, BigNumberish],
    overrides?: PayableOverrides
  ): Promise<ContractTransaction>;
  ...
  abstract 'payToTree(address,uint256[3])'(
    _networker: string,
    _rewardRatio: [BigNumberish, BigNumberish, BigNumberish],
    overrides?: PayableOverrides
  ): Promise<ContractTransaction>;

  abstract prepaidEs(overrides?: CallOverrides): Promise<string>;

  abstract 'prepaidEs()'(overrides?: CallOverrides): Promise<string>;

  abstract promoteBelt(
    _networker: string,
    _month: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'promoteBelt(address,uint32)'(
    _networker: string,
    _month: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract randomnessManager(overrides?: CallOverrides): Promise<string>;
  ...
  abstract reportVolume(
    _networker: string,
    _amount: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'reportVolume(address,uint256)'(
    _networker: string,
    _amount: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract resolveAddress(_username: BytesLike, overrides?: CallOverrides): Promise<string>;

  abstract 'resolveAddress(bytes32)'(
    _username: BytesLike,
    overrides?: CallOverrides
  ): Promise<string>;

  abstract resolveAddressStrict(_username: BytesLike, overrides?: CallOverrides): Promise<string>;

  abstract 'resolveAddressStrict(bytes32)'(
    _username: BytesLike,
    overrides?: CallOverrides
  ): Promise<string>;

  abstract resolveIntroducer(_networker: string, overrides?: CallOverrides): Promise<string>;

  abstract 'resolveIntroducer(address)'(
    _networker: string,
    overrides?: CallOverrides
  ): Promise<string>;

  abstract resolveKyc(_networker: string, overrides?: Overrides): Promise<ContractTransaction>;

  abstract 'resolveKyc(address)'(
    _networker: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract resolveUsername(_wallet: string, overrides?: CallOverrides): Promise<string>;

  abstract 'resolveUsername(address)'(_wallet: string, overrides?: CallOverrides): Promise<string>;

  abstract resolveUsernameStrict(_wallet: string, overrides?: CallOverrides): Promise<string>;

  abstract 'resolveUsernameStrict(address)'(
    _wallet: string,
    overrides?: CallOverrides
  ): Promise<string>;

  abstract rewardToTree(
    _networker: string,
    _value: BigNumberish,
    _rewardRatio: [BigNumberish, BigNumberish, BigNumberish],
    overrides?: Overrides
  ...
  abstract 'rewardToTree(address,uint256,uint256[3])'(
    _networker: string,
    _value: BigNumberish,
    _rewardRatio: [BigNumberish, BigNumberish, BigNumberish],
    overrides?: Overrides
  ...
  abstract setNullWallet(_nullWallet: string, overrides?: Overrides): Promise<ContractTransaction>;

  abstract 'setNullWallet(address)'(
    _nullWallet: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract setVolumeTarget(
    _volumeTarget: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'setVolumeTarget(uint256)'(
    _volumeTarget: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract timeallyClub(overrides?: CallOverrides): Promise<string>;
  ...
  abstract transferSeat(_newOwner: string, overrides?: Overrides): Promise<ContractTransaction>;

  abstract 'transferSeat(address)'(
    _newOwner: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract updateAuthorization(
    _username: BytesLike,
    _newStatus: boolean,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'updateAuthorization(bytes32,bool)'(
    _username: BytesLike,
    _newStatus: boolean,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract validatorManager(overrides?: CallOverrides): Promise<string>;
  ...
  abstract 'withdrawDefiniteEarnings(address,uint32,uint8)'(
    _stakingContract: string,
    _month: BigNumberish,
    _rewardType: BigNumberish,
    overrides?: Overrides
  ...
  abstract 'withdrawNrtEarnings(address,uint32,uint8)'(
    _stakingContract: string,
    _month: BigNumberish,
    _rewardType: BigNumberish,
    overrides?: Overrides
