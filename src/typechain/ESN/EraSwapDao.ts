...
export abstract class EraSwapDao extends Contract {
  ...
  abstract interface: EraSwapDaoInterface;
   ...
   * @param pending Include pending transactions.
   */
  abstract 'getTransactionCount(bool,bool)'(
    pending: boolean,
    executed: boolean,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * @param to Index end position of transaction array.
   */
  abstract 'getTransactionIds(uint256,uint256,bool,bool)'(
    from: BigNumberish,
    to: BigNumberish,
    pending: boolean,
    executed: boolean,
  ...
  abstract getVotingPreviledge(
    _staking: string,
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;

  abstract 'getVotingPreviledge(address,uint32)'(
    _staking: string,
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
  ...
  abstract 'required(uint32)'(_month: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

  abstract 'required()'(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  abstract transactionCount(overrides?: CallOverrides): Promise<BigNumber>;
