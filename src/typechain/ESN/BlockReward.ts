...
export abstract class BlockReward extends Contract {
  ...
  abstract interface: BlockRewardInterface;
   ...
   * @param benefactors : Addresses of sealers.
   */
  abstract 'reward(address[],uint16[])'(
    benefactors: string[],
    arg1: BigNumberish[],
    overrides?: Overrides
  ): Promise<ContractTransaction>;
  ...
  abstract estimateGas: {
     ...
     * @param benefactors : Addresses of sealers.
     */
    reward(benefactors: string[], arg1: BigNumberish[], overrides?: Overrides): Promise<BigNumber>;
