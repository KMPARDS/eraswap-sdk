...
interface PetLiquidFlattenAuthorizableInterface extends ethers.utils.Interface {
  functions: {
...
export class PetLiquidFlattenAuthorizable extends Contract {
  ...
  interface: PetLiquidFlattenAuthorizableInterface;
