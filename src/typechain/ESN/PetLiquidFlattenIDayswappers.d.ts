...
interface PetLiquidFlattenIDayswappersInterface extends ethers.utils.Interface {
  functions: {
...
export class PetLiquidFlattenIDayswappers extends Contract {
  ...
  interface: PetLiquidFlattenIDayswappersInterface;
