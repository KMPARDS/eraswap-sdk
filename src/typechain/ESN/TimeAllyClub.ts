...
export abstract class TimeAllyClub extends Contract {
  ...
  abstract interface: TimeAllyClubInterface;
  ...
  abstract 'getIncentiveSlab(uint256,address)'(
    _volume: BigNumberish,
    _platform: string,
    overrides?: CallOverrides
  ): Promise<{
  ...
  abstract 'getMembershipVolume(address,uint32)'(
    _networker: string,
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
  ...
  abstract 'getPlatformBusiness(address,uint32,address)'(
    _network: string,
    _month: BigNumberish,
    _platform: string,
    overrides?: CallOverrides
  ...
  abstract 'getReward(address,uint32,address)'(
    _networker: string,
    _month: BigNumberish,
    _platform: string,
    overrides?: CallOverrides
  ...
  abstract getTotalBusinessVolume(
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;

  abstract 'getTotalBusinessVolume(uint32)'(
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
  ...
  abstract reportNewStaking(
    _networker: string,
    _value: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'reportNewStaking(address,uint256)'(
    _networker: string,
    _value: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
  ...
  abstract rewardToIntroducer(
    _networker: string,
    _value: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'rewardToIntroducer(address,uint256)'(
    _networker: string,
    _value: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract rewardToNetworker(
    _networker: string,
    _value: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'rewardToNetworker(address,uint256)'(
    _networker: string,
    _value: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
  ...
  abstract setPlatformIncentives(
    _platform: string,
    _incentiveStructure: {
      label: string;
      target: BigNumberish;
  ...
  abstract 'setPlatformIncentives(address,tuple[])'(
    _platform: string,
    _incentiveStructure: {
      label: string;
      target: BigNumberish;
  ...
  abstract withdrawPlatformIncentive(
    _month: BigNumberish,
    _platform: string,
    _rewardType: BigNumberish,
    _stakingContract: string,
  ...
  abstract 'withdrawPlatformIncentive(uint32,address,uint8,address)'(
    _month: BigNumberish,
    _platform: string,
    _rewardType: BigNumberish,
    _stakingContract: string,
