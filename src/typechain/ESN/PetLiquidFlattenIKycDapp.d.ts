...
interface PetLiquidFlattenIKycDappInterface extends ethers.utils.Interface {
  functions: {
...
export class PetLiquidFlattenIKycDapp extends Contract {
  ...
  interface: PetLiquidFlattenIKycDappInterface;
