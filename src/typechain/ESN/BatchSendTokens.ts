...
export abstract class BatchSendTokens extends Contract {
  ...
  abstract interface: BatchSendTokensInterface;
   ...
   * @param totalAmount - amount of total tokens in one batch
   */
  abstract sendErc20ByDifferentAmount(
    token: string,
    addressArray: string[],
    amountArray: BigNumberish[],
    totalAmount: BigNumberish,
   ...
   * @param totalAmount - amount of total tokens in one batch
   */
  abstract 'sendErc20ByDifferentAmount(address,address[],uint256[],uint256)'(
    token: string,
    addressArray: string[],
    amountArray: BigNumberish[],
    totalAmount: BigNumberish,
   ...
   * @param totalAmount - amount of total tokens in one batch
   */
  abstract sendErc20BySameAmount(
    token: string,
    addressArray: string[],
    amountToEachAddress: BigNumberish,
    totalAmount: BigNumberish,
   ...
   * @param totalAmount - amount of total tokens in one batch
   */
  abstract 'sendErc20BySameAmount(address,address[],uint256,uint256)'(
    token: string,
    addressArray: string[],
    amountToEachAddress: BigNumberish,
    totalAmount: BigNumberish,
  ...
  abstract sendNativeByDifferentAmount(
    addressArray: string[],
    amountArray: BigNumberish[],
    overrides?: PayableOverrides
  ): Promise<ContractTransaction>;

  abstract 'sendNativeByDifferentAmount(address[],uint256[])'(
    addressArray: string[],
    amountArray: BigNumberish[],
    overrides?: PayableOverrides
  ): Promise<ContractTransaction>;
