...
import type { PetLiquidFlattenIKycDapp } from "./PetLiquidFlattenIKycDapp";

export class PetLiquidFlattenIKycDappFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PetLiquidFlattenIKycDapp {
    return new Contract(
      address,
      _abi,
      signerOrProvider
    ) as PetLiquidFlattenIKycDapp;
  }
}
