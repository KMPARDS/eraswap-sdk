...
export abstract class BuildSurvey extends Contract {
  ...
  abstract interface: BuildSurveyInterface;
  ...
  abstract accessUser(arg0: BytesLike, arg1: string, overrides?: CallOverrides): Promise<number>;

  abstract 'accessUser(bytes32,address)'(
    arg0: BytesLike,
    arg1: string,
    overrides?: CallOverrides
  ): Promise<number>;
  ...
  abstract 'addSurvey(string,uint256,bool)'(
    _title: string,
    _time: BigNumberish,
    _ispublic: boolean,
    overrides?: PayableOverrides
  ...
  abstract 'addUsers(bytes32,address[])'(
    _survey: BytesLike,
    users: string[],
    overrides?: Overrides
  ): Promise<ContractTransaction>;
  ...
  abstract 'sendSurvey(bytes32,uint16[])'(
    _survey: BytesLike,
    _feedback: BigNumberish[],
    overrides?: Overrides
  ): Promise<ContractTransaction>;
