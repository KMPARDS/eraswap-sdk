...
export abstract class RentingDappManager extends Contract {
  ...
  abstract interface: RentingDappManagerInterface;
  ...
  abstract 'addItem(string,string,uint256,uint256,uint256,string,bytes32,uint48)'(
    _name: string,
    _location: string,
    _maxRent: BigNumberish,
    _security: BigNumberish,
  ...
  abstract isAvailable(arg0: string, overrides?: CallOverrides): Promise<boolean>;

  abstract 'isAvailable(address)'(arg0: string, overrides?: CallOverrides): Promise<boolean>;

  abstract items(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;

  abstract 'items(uint256)'(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
  ...
  abstract removeItem(_item: string, overrides?: Overrides): Promise<ContractTransaction>;

  abstract 'removeItem(address)'(
    _item: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
