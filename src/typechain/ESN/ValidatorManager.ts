...
interface ValidatorManagerInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getCommission', values: [BigNumberish, string]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'getCommission', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'getDelegationShare', data: BytesLike): Result;
...
export abstract class ValidatorManager extends Contract {
  ...
  abstract interface: ValidatorManagerInterface;
  ...
  abstract functions: {
    ...
    'getDelegationShare(uint32,address,address)'(
      _month: BigNumberish,
      _validator: string,
      _stakingContract: string,
      overrides?: CallOverrides
   ...
   * @param _premiumFactor : Factor in which premium increases.
   */
  abstract 'getAdjustedAmount(uint256,uint256,uint256)'(
    _amount: BigNumberish,
    _base: BigNumberish,
    _premiumFactor: BigNumberish,
    overrides?: CallOverrides
  ...
  abstract getCommission(
    _month: BigNumberish,
    _validator: string,
    overrides?: CallOverrides
  ): Promise<BigNumber>;

  abstract 'getCommission(uint32,address)'(
    _month: BigNumberish,
    _validator: string,
    overrides?: CallOverrides
  ): Promise<BigNumber>;

  abstract getDelegationShare(
    _month: BigNumberish,
    _validator: string,
    _stakingContract: string,
    overrides?: CallOverrides
  ...
  abstract 'getDelegationShare(uint32,address,address)'(
    _month: BigNumberish,
    _validator: string,
    _stakingContract: string,
    overrides?: CallOverrides
   ...
   * @param _validator : Address of the validator.
   */
  abstract getDelegatorByAddress(
    _month: BigNumberish,
    _validator: string,
    _stakingContract: string,
    overrides?: CallOverrides
   ...
   * @param _validator : Address of the validator.
   */
  abstract 'getDelegatorByAddress(uint32,address,address)'(
    _month: BigNumberish,
    _validator: string,
    _stakingContract: string,
    overrides?: CallOverrides
   ...
   * @param _validatorIndex : Index of validator in array.
   */
  abstract 'getDelegatorByIndex(uint32,uint256,uint256)'(
    _month: BigNumberish,
    _validatorIndex: BigNumberish,
    _delegatorIndex: BigNumberish,
    overrides?: CallOverrides
   ...
   * @param _validatorIndex : Index of the validator.
   */
  abstract 'getDelegatorIndex(uint32,uint256,address)'(
    _month: BigNumberish,
    _validatorIndex: BigNumberish,
    _stakingContract: string,
    overrides?: CallOverrides
   ...
   * Gets address of a lucky vaidator based on PoS.
   */
  abstract getLuckyValidatorAddress(overrides?: Overrides): Promise<ContractTransaction>;
   ...
   * @param _month : NRT Month.
   */
  abstract getTotalAdjustedStakings(
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * @param _month : NRT Month.
   */
  abstract 'getTotalAdjustedStakings(uint32)'(
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * @param _month : NRT Month.
   */
  abstract 'getTotalBlocksSealed(uint32)'(
    _month: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * @param _validator : Address of validator.
   */
  abstract getValidatorByAddress(
    _month: BigNumberish,
    _validator: string,
    overrides?: CallOverrides
  ): Promise<{
   ...
   * @param _validator : Address of validator.
   */
  abstract 'getValidatorByAddress(uint32,address)'(
    _month: BigNumberish,
    _validator: string,
    overrides?: CallOverrides
  ): Promise<{
   ...
   * @param _validatorIndex : Index of the validator in array.
   */
  abstract 'getValidatorByIndex(uint32,uint256)'(
    _month: BigNumberish,
    _validatorIndex: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
   ...
   * @param _validator : Address of validator.
   */
  abstract 'getValidatorEarning(uint32,address)'(
    _month: BigNumberish,
    _validator: string,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * @param _validator : Address of the validator.
   */
  abstract 'getValidatorIndex(uint32,address)'(
    _month: BigNumberish,
    _validator: string,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * @param _seed : Pseudo random seed.
   */
  abstract 'pickValidator(uint32,uint256)'(
    _month: BigNumberish,
    _seed: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * @param _sealer : Address of validator who sealed the block.
   */
  abstract registerBlock(_sealer: string, overrides?: Overrides): Promise<ContractTransaction>;

  /**
   * Allows block reward contract to register a sealed block by validator.
   * @param _sealer : Address of validator who sealed the block.
   */
  abstract 'registerBlock(address)'(
    _sealer: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * @param _perThousandCommission : Per thousand commission of validator.
   */
  abstract 'setCommission(uint32,uint256)'(
    _month: BigNumberish,
    _perThousandCommission: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * Allows NRT Manager contract to send NRT share for Validator Manager.
   */
  abstract setInitialValues(overrides?: CallOverrides): Promise<void>;
   ...
   * @param _month : NRT Month.
   */
  abstract 'withdrawCommission(uint32)'(
    _month: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * @param _validator : Address of validator.
   */
  abstract withdrawDelegationShare(
    _month: BigNumberish,
    _validator: string,
    _stakingContract: string,
    overrides?: Overrides
   ...
   * @param _validator : Address of validator.
   */
  abstract 'withdrawDelegationShare(uint32,address,address)'(
    _month: BigNumberish,
    _validator: string,
    _stakingContract: string,
    overrides?: Overrides
