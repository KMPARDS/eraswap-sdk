...
interface PetLiquidFlattenFundsBucketInterface extends ethers.utils.Interface {
  functions: {
...
export class PetLiquidFlattenFundsBucket extends Contract {
  ...
  interface: PetLiquidFlattenFundsBucketInterface;
