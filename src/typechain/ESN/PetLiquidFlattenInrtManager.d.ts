...
interface PetLiquidFlattenInrtManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class PetLiquidFlattenInrtManager extends Contract {
  ...
  interface: PetLiquidFlattenInrtManagerInterface;
