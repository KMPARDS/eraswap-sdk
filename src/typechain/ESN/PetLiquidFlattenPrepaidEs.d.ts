...
interface PetLiquidFlattenPrepaidEsInterface extends ethers.utils.Interface {
  functions: {
...
export class PetLiquidFlattenPrepaidEs extends Contract {
  ...
  interface: PetLiquidFlattenPrepaidEsInterface;
