...
export abstract class KycDapp extends Contract {
  ...
  abstract interface: KycDappInterface;
  ...
  abstract 'applyForKyc(uint8,bytes32,bytes32)'(
    _level: BigNumberish,
    _platformIdentifier: BytesLike,
    _specialization: BytesLike,
    overrides?: PayableOverrides
  ...
  abstract approveKycDetails(
    _username: BytesLike,
    _kycUnapprovedDetailsIPFS: BytesLike,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'approveKycDetails(bytes32,bytes32)'(
    _username: BytesLike,
    _kycUnapprovedDetailsIPFS: BytesLike,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
  ...
  abstract 'getIdentityByAddress(address)'(
    _wallet: string,
    overrides?: CallOverrides
  ): Promise<{
    username: string;
  ...
  abstract getIdentityByUsername(
    _username: BytesLike,
    overrides?: CallOverrides
  ): Promise<{
    username: string;
  ...
  abstract 'getIdentityByUsername(bytes32)'(
    _username: BytesLike,
    overrides?: CallOverrides
  ): Promise<{
    username: string;
  ...
  abstract 'getKycFee(uint8,bytes32,bytes32)'(
    _level: BigNumberish,
    _platformIdentifier: BytesLike,
    _specialization: BytesLike,
    overrides?: CallOverrides
  ...
  abstract getKycStatusByAddress(
    _wallet: string,
    _level: BigNumberish,
    _platformIdentifier: BytesLike,
    _specialization: BytesLike,
  ...
  abstract 'getKycStatusByAddress(address,uint8,bytes32,bytes32)'(
    _wallet: string,
    _level: BigNumberish,
    _platformIdentifier: BytesLike,
    _specialization: BytesLike,
  ...
  abstract getKycStatusByUsername(
    _username: BytesLike,
    _level: BigNumberish,
    _platformIdentifier: BytesLike,
    _specialization: BytesLike,
  ...
  abstract 'getKycStatusByUsername(bytes32,uint8,bytes32,bytes32)'(
    _username: BytesLike,
    _level: BigNumberish,
    _platformIdentifier: BytesLike,
    _specialization: BytesLike,
  ...
  abstract identityTransfer(
    _username: BytesLike,
    _newWallet: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'identityTransfer(bytes32,address)'(
    _username: BytesLike,
    _newWallet: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract isKycApproved(
    _wallet: string,
    _level: BigNumberish,
    _platformIdentifier: BytesLike,
    _specialization: BytesLike,
  ...
  abstract 'isKycApproved(address,uint8,bytes32,bytes32)'(
    _wallet: string,
    _level: BigNumberish,
    _platformIdentifier: BytesLike,
    _specialization: BytesLike,
  ...
  abstract isKycLevel1(_wallet: string, overrides?: CallOverrides): Promise<boolean>;

  abstract 'isKycLevel1(address)'(_wallet: string, overrides?: CallOverrides): Promise<boolean>;
   ...
   * This emits an event and admin can catch that and check it. And if ok then can approve it using a function
   */
  abstract 'proposeKycDetails(bytes32)'(
    _kycUnapprovedDetailsIPFS: BytesLike,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
  ...
  abstract 'updateKycFee(uint8,bytes32,bytes32,uint256)'(
    _level: BigNumberish,
    _platformIdentifier: BytesLike,
    _specialization: BytesLike,
    _amount: BigNumberish,
  ...
  abstract 'updateKycStatus(bytes32,uint8,bytes32,bytes32,uint8)'(
    _username: BytesLike,
    _level: BigNumberish,
    _platformIdentifier: BytesLike,
    _specialization: BytesLike,
  ...
  abstract usernames(arg0: string, overrides?: CallOverrides): Promise<string>;

  abstract 'usernames(address)'(arg0: string, overrides?: CallOverrides): Promise<string>;
