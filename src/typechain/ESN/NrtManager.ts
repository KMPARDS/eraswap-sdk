...
export abstract class NrtManager extends Contract {
  ...
  abstract interface: NrtManagerInterface;
   ...
   * A destination for tokens which are destined to be unspendable forever.
   */
  abstract BURN_ADDR(overrides?: CallOverrides): Promise<string>;
  ...
  abstract SECONDS_IN_MONTH(overrides?: CallOverrides): Promise<number>;
   ...
   * Annual amount which is released monthly during first year. On end         of a year, this amount decreases by 10%.
   */
  abstract annualNRT(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * Amount of tokens accrued for burning as per Era Swap Whitepaper.
   */
  abstract burnPoolBalance(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * Gets tokens allowed to be burned during upcoming NRT.
   */
  abstract getBurnAmount(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * @param _perThousandIndex : Index of platform.
   */
  abstract 'getPerThousand(uint256)'(
    _perThousandIndex: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * Gets all nrt shares of platforms.
   */
  abstract getPerThousands(overrides?: CallOverrides): Promise<BigNumber[]>;
   ...
   * @param _platformIndex : Index of platform.
   */
  abstract getPlatform(_platformIndex: BigNumberish, overrides?: CallOverrides): Promise<string>;

  /**
   * Gets platform address by index.
   * @param _platformIndex : Index of platform.
   */
  abstract 'getPlatform(uint256)'(
    _platformIndex: BigNumberish,
    overrides?: CallOverrides
  ): Promise<string>;
   ...
   * Gets all platform addresses.
   */
  abstract getPlatforms(overrides?: CallOverrides): Promise<string[]>;
   ...
   * Timestamp of the block in which last NRT transaction was sealed.
   */
  abstract lastReleaseTimestamp(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * Amount of tokens accrued for the month by luck as per Era Swap Whitepaper.
   */
  abstract luckPoolBalance(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * Sends NRT share to the platforms and burns tokens from burn pool as per Era Swap Whitepaper.
   */
  abstract releaseMonthlyNRT(overrides?: Overrides): Promise<ContractTransaction>;
   ...
   * @param _platformIdentifiers : Addresses of platform smart contracts or wallets.
   */
  abstract 'setPlatforms(bytes32[],uint256[])'(
    _platformIdentifiers: BytesLike[],
    _perThousands: BigNumberish[],
    overrides?: PayableOverrides
  ): Promise<ContractTransaction>;
