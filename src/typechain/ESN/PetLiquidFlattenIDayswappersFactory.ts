...
import type { PetLiquidFlattenIDayswappers } from "./PetLiquidFlattenIDayswappers";

export class PetLiquidFlattenIDayswappersFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PetLiquidFlattenIDayswappers {
    return new Contract(
      address,
      _abi,
      signerOrProvider
    ) as PetLiquidFlattenIDayswappers;
  }
}
