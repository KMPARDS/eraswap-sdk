...
export abstract class BetDeEx extends Contract {
  ...
  abstract interface: BetDeExInterface;
  ...
  abstract clonedContracts(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;

  abstract 'clonedContracts(uint256)'(
    arg0: BigNumberish,
    overrides?: CallOverrides
  ): Promise<string>;
  ...
  abstract 'createBet(string,uint8,uint8,uint256,uint256,bool,uint256)'(
    _description: string,
    _category: BigNumberish,
    _subCategory: BigNumberish,
    _minimumBetInExaEs: BigNumberish,
   ...
   * this is an internal functionality that is only for bet contracts to emit event when a bet is ended so that front end can get the information by subscribing to  contract
   */
  abstract 'emitEndBetEvent(address,uint8,uint256)'(
    _ender: string,
    _result: BigNumberish,
    _gasFee: BigNumberish,
    overrides?: Overrides
   ...
   * this is an internal functionality that is only for bet contracts to emit a event when a new bet is placed so that front end can get the information by subscribing to  contract
   */
  abstract 'emitNewBettingEvent(address,uint8,uint256)'(
    _bettorAddress: string,
    _choice: BigNumberish,
    _betTokensInExaEs: BigNumberish,
    overrides?: Overrides
   ...
   * this function is used for getting total number of bets
   */
  abstract getNumberOfBets(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  abstract implementation(overrides?: CallOverrides): Promise<string>;

  abstract 'implementation()'(overrides?: CallOverrides): Promise<string>;

  abstract isBetValid(arg0: string, overrides?: CallOverrides): Promise<boolean>;

  abstract 'isBetValid(address)'(arg0: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  abstract storageFactory(
    _implementation: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'storageFactory(address)'(
    _implementation: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
