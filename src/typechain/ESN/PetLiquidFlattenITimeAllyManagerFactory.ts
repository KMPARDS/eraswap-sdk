...
import type { PetLiquidFlattenITimeAllyManager } from "./PetLiquidFlattenITimeAllyManager";

export class PetLiquidFlattenITimeAllyManagerFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PetLiquidFlattenITimeAllyManager {
    return new Contract(
      address,
      _abi,
      signerOrProvider
    ) as PetLiquidFlattenITimeAllyManager;
  }
}
