...
interface PetLiquidFlattenInrtReceiverInterface extends ethers.utils.Interface {
  functions: {
...
export class PetLiquidFlattenInrtReceiver extends Contract {
  ...
  interface: PetLiquidFlattenInrtReceiverInterface;
