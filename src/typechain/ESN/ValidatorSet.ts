...
export abstract class ValidatorSet extends Contract {
  ...
  abstract interface: ValidatorSetInterface;
   ...
   * Interval of blocks after which change can be initiated.
   */
  abstract BLOCKS_INTERVAL(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * Number of tries to do before settling for a lower length of set.
   */
  abstract LUCK_TRIES(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * Maximum validators in a set.
   */
  abstract MAX_VALIDATORS(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * Amount of unique validators required in the set to prevent duplicates.
   */
  abstract PERCENT_UNIQUE(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * Address from which system transaction come.
   */
  abstract SYSTEM_ADDRESS(overrides?: CallOverrides): Promise<string>;
   ...
   * Finalizes the change
   */
  abstract finalizeChange(overrides?: Overrides): Promise<ContractTransaction>;
   ...
   * Gets list of next validators.
   */
  abstract getNextValidators(overrides?: CallOverrides): Promise<string[]>;
   ...
   * Gets list of existing validators.
   */
  abstract getValidators(overrides?: CallOverrides): Promise<string[]>;
   ...
   * Allocates next validators and emits InitiateChange event.
   */
  abstract initiateChange(overrides?: Overrides): Promise<ContractTransaction>;
   ...
   * Last block number in which finaliseChange was called by system.         If this is zero means, system is yet to call this method.
   */
  abstract lastFinalizeChangeBlock(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  abstract setBlocksInterval(
    _BLOCKS_INTERVAL: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'setBlocksInterval(uint256)'(
    _BLOCKS_INTERVAL: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
  ...
  abstract setLuckTries(
    _LUCK_TRIES: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'setLuckTries(uint256)'(
    _LUCK_TRIES: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract setMaxValidators(
    _MAX_VALIDATORS: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'setMaxValidators(uint256)'(
    _MAX_VALIDATORS: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract setPercentUnique(
    _PERCENT_UNIQUE: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'setPercentUnique(uint256)'(
    _PERCENT_UNIQUE: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
