...
export abstract class Tsgap extends Contract {
  ...
  abstract interface: TsgapInterface;
  ...
  abstract EARTH_SECONDS_IN_MONTH(overrides?: CallOverrides): Promise<number>;
   ...
   * this function is used by donors to add funds to fundsDeposit
   */
  abstract addFunds(overrides?: PayableOverrides): Promise<ContractTransaction>;
   ...
   * @param _stakerAddress : address of initiater of this SIP.
   */
  abstract 'appointeeVote(address,uint32)'(
    _stakerAddress: string,
    _sipId: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * @param _monthlyBenefitFactor : this is per 1000; i.e 200 for 20%
   */
  abstract 'createSIPPlan(uint256,uint32,uint32,uint32,uint32,uint32,uint32)'(
    _minimumMonthlyCommitmentAmount: BigNumberish,
    _accumulationPeriodMonths: BigNumberish,
    _benefitPeriodYears: BigNumberish,
    _gracePeriodSeconds: BigNumberish,
   ...
   * deposited by Era Swap Donors. It is given as benefits to  ES stakers. on every withdrawl this deposit is reduced, and on some point of time if enough fundsDeposit is not available to assure staker benefit, contract will allow staker to deposit
   */
  abstract fundsDeposit(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * @param _stakerAddress : address of initiater of this SIP.
   */
  abstract 'getDepositDoneStatus(address,uint32,uint32)'(
    _stakerAddress: string,
    _sipId: BigNumberish,
    _monthId: BigNumberish,
    overrides?: CallOverrides
   ...
   * @param _stakerAddress : address of initiater of this SIP.
   */
  abstract 'getDepositStatus(address,uint32,uint32)'(
    _stakerAddress: string,
    _sipId: BigNumberish,
    _monthId: BigNumberish,
    overrides?: CallOverrides
   ...
   * @param _withdrawlMonthId : withdrawl month id upto which to calculate returns for
   */
  abstract getPendingWithdrawlAmount(
    _stakerAddress: string,
    _sipId: BigNumberish,
    _withdrawlMonthId: BigNumberish,
    _isNomineeWithdrawing: boolean,
   ...
   * @param _withdrawlMonthId : withdrawl month id upto which to calculate returns for
   */
  abstract 'getPendingWithdrawlAmount(address,uint32,uint32,bool)'(
    _stakerAddress: string,
    _sipId: BigNumberish,
    _withdrawlMonthId: BigNumberish,
    _isNomineeWithdrawing: boolean,
  ...
  abstract 'getSip(address,uint32)'(
    _staker: string,
    _sipId: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
  ...
  abstract 'migrateDeposit(address,uint32,uint32,uint8)'(
    _stakerAddress: string,
    _sipId: BigNumberish,
    _monthId: BigNumberish,
    _depositStatusAdmin: BigNumberish,
  ...
  abstract 'migrateSip(address,uint32,uint48,uint32,uint32)'(
    _staker: string,
    _planId: BigNumberish,
    _stakingTimestamp: BigNumberish,
    _lastWithdrawlMonthId: BigNumberish,
   ...
   * @param _monthId : specify the month to deposit
   */
  abstract 'monthlyDeposit(address,uint32,uint32)'(
    _stakerAddress: string,
    _sipId: BigNumberish,
    _monthId: BigNumberish,
    overrides?: PayableOverrides
   ...
   * whenever a deposit is done by user, benefit amount (to be paid in due plan time) will be already added to this. and in case of withdrawl, it is subtracted from this.
   */
  abstract pendingBenefitAmountOfAllStakers(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * @param _sipId : id of SIP in staker portfolio.
   */
  abstract 'toogleAppointee(uint32,address,bool)'(
    _sipId: BigNumberish,
    _appointeeAddress: string,
    _newAppointeeStatus: boolean,
    overrides?: Overrides
   ...
   * @param _sipId : id of SIP in staker portfolio.
   */
  abstract 'toogleNominee(uint32,address,bool)'(
    _sipId: BigNumberish,
    _nomineeAddress: string,
    _newNomineeStatus: boolean,
    overrides?: Overrides
  ...
  abstract viewMonthlyBenefitAmount(
    _stakerAddress: string,
    _sipId: BigNumberish,
    _depositMonthId: BigNumberish,
    overrides?: CallOverrides
  ...
  abstract 'viewMonthlyBenefitAmount(address,uint32,uint32)'(
    _stakerAddress: string,
    _sipId: BigNumberish,
    _depositMonthId: BigNumberish,
    overrides?: CallOverrides
   ...
   * @param _withdrawlMonthId : withdraw month id starts from 1 upto as per plan.
   */
  abstract 'withdrawBenefit(address,uint32,uint32)'(
    _stakerAddress: string,
    _sipId: BigNumberish,
    _withdrawlMonthId: BigNumberish,
    overrides?: Overrides
   ...
   * @param _withdrawlAmount : amount in exaES to withdraw
   */
  abstract 'withdrawFunds(uint256)'(
    _withdrawlAmount: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * @param _stakerAddress : address of initiater of this SIP.
   */
  abstract 'withdrawPowerBooster(address,uint32)'(
    _stakerAddress: string,
    _sipId: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
