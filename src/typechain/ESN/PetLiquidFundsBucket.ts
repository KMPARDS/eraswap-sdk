...
export abstract class PetLiquidFundsBucket extends Contract {
  ...
  abstract interface: PetLiquidFundsBucketInterface;
   ...
   * transfers funds to PET contract
   */
  abstract 'allocateFunds(uint256)'(
    _amount: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
