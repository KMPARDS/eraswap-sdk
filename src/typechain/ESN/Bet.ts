...
export abstract class Bet extends Contract {
  ...
  abstract bettorBetAmountInExaEsByChoice(
    arg0: string,
    arg1: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;

  abstract 'bettorBetAmountInExaEsByChoice(address,uint256)'(
    arg0: string,
    arg1: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;

  abstract bettorHasClaimed(arg0: string, overrides?: CallOverrides): Promise<boolean>;

  abstract 'bettorHasClaimed(address)'(arg0: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  abstract downVotes(overrides?: CallOverrides): Promise<BigNumber>;

  abstract 'downVotes()'(overrides?: CallOverrides): Promise<BigNumber>;

  abstract downvote(overrides?: Overrides): Promise<ContractTransaction>;
   ...
   * @param _choice is the correct choice
   */
  abstract endBet(_choice: BigNumberish, overrides?: Overrides): Promise<ContractTransaction>;

  /**
   * this function is used by manager to load correct answer
   * @param _choice is the correct choice
   */
  abstract 'endBet(uint8)'(
    _choice: BigNumberish,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract endTimestamp(overrides?: CallOverrides): Promise<BigNumber>;

  abstract 'endTimestamp()'(overrides?: CallOverrides): Promise<BigNumber>;

  abstract endedBy(overrides?: CallOverrides): Promise<string>;
  ...
  abstract finalResult(overrides?: CallOverrides): Promise<number>;

  abstract 'finalResult()'(overrides?: CallOverrides): Promise<number>;

  abstract getNumberOfChoiceBettors(
    arg0: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;

  abstract 'getNumberOfChoiceBettors(uint256)'(
    arg0: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * @param _subCategory is a specific category for example Football. Each category will have sub categories represented by a number (0, 1, 2, 3...)
   */
  abstract 'initialize(address,string,uint8,uint8,uint256,uint256,bool,uint256,address)'(
    _owner1: string,
    _description: string,
    _category: BigNumberish,
    _subCategory: BigNumberish,
  ...
  abstract isDrawPossible(overrides?: CallOverrides): Promise<boolean>;
  ...
  abstract minimumBetInExaEs(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  abstract pauseTimestamp(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  abstract prizePercentPerThousand(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * @param _bettorAddress is address whose prize we want to see
   */
  abstract seeWinnerPrize(_bettorAddress: string, overrides?: CallOverrides): Promise<BigNumber>;

  /**
   * this function can be called by anyone to see how much winners are getting
   * @param _bettorAddress is address whose prize we want to see
   */
  abstract 'seeWinnerPrize(address)'(
    _bettorAddress: string,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
  ...
  abstract subCategory(overrides?: CallOverrides): Promise<number>;
  ...
  abstract totalBetTokensInExaEsByChoice(
    arg0: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;

  abstract 'totalBetTokensInExaEsByChoice(uint256)'(
    arg0: BigNumberish,
    overrides?: CallOverrides
  ): Promise<BigNumber>;
   ...
   * this function gives amount of ExaEs that is total betted on this bet
   */
  abstract totalContractBalance(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  abstract totalPrize(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  abstract upVotes(overrides?: CallOverrides): Promise<BigNumber>;

  abstract 'upVotes()'(overrides?: CallOverrides): Promise<BigNumber>;

  abstract upvote(overrides?: Overrides): Promise<ContractTransaction>;
   ...
   * this function will be called after bet ends and winner bettors can withdraw their prize share
   */
  abstract 'withdrawPrize(address)'(
    _bettorAddress: string,
    overrides?: PayableOverrides
  ): Promise<ContractTransaction>;
