...
interface PetLiquidFlattenIPrepaidEsInterface extends ethers.utils.Interface {
  functions: {
...
export class PetLiquidFlattenIPrepaidEs extends Contract {
  ...
  interface: PetLiquidFlattenIPrepaidEsInterface;
